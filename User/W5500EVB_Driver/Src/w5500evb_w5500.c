...
/// <summary>	-------------W5500 pin based on HAL------------ </summary>

#define W5500_INT_CLK_ENABLE()						__HAL_RCC_GPIOC_CLK_ENABLE()
#define W5500_RESET_CLK_ENABLE()					__HAL_RCC_GPIOB_CLK_ENABLE()
...
/// <summary>	-----------SPI specific based on HAL----------- </summary>

#define W5500SPIInterface_SPIx						SPI2

static SPI_HandleTypeDef W5500SPIInterfaceHandle;
...
/// <summary>	-----------SPI function based on HAL----------- </summary>
...
{
	W5500SPIInterfaceHandle.Instance = W5500SPIInterface_SPIx;
	W5500SPIInterfaceHandle.Init.Mode = SPI_MODE_MASTER;
	W5500SPIInterfaceHandle.Init.Direction = SPI_DIRECTION_2LINES;
	W5500SPIInterfaceHandle.Init.DataSize = SPI_DATASIZE_8BIT;
	W5500SPIInterfaceHandle.Init.CLKPolarity = SPI_POLARITY_LOW;
	W5500SPIInterfaceHandle.Init.CLKPhase = SPI_PHASE_1EDGE;
	W5500SPIInterfaceHandle.Init.NSS = SPI_NSS_SOFT;
	W5500SPIInterfaceHandle.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_4;
	W5500SPIInterfaceHandle.Init.FirstBit = SPI_FIRSTBIT_MSB;
	W5500SPIInterfaceHandle.Init.TIMode = SPI_TIMODE_DISABLE;
	W5500SPIInterfaceHandle.Init.CRCCalculation = SPI_CRCCALCULATION_DISABLE;
	W5500SPIInterfaceHandle.Init.CRCPolynomial = 10;

	HAL_SPI_Init(&W5500SPIInterfaceHandle);

	__HAL_SPI_ENABLE(&W5500SPIInterfaceHandle);
}
...
uint8_t W5500SPIInterface_SendByte(uint8_t byte)
{
	...
	HAL_SPI_TransmitReceive(&W5500SPIInterfaceHandle, &byte, &data, 1, 100);
