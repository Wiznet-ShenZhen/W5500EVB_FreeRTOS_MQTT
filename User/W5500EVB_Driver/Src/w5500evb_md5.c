...
///-------------------------------------------------------------------------------------------------
/// <summary>	Constants for Transform routine. </summary>
///
/// <remarks>	Tony Wang, 15:42 19/3/21. </remarks>
///-------------------------------------------------------------------------------------------------
...
///-------------------------------------------------------------------------------------------------
/// <summary>	F, G, H and I are basic md5 functions. </summary>
///
/// <remarks>	Tony Wang, 15:43 19/3/21. </remarks>
///
/// <param name="x">	A void to process. </param>
/// <param name="y">	A void to process. </param>
/// <param name="z">	A void to process. </param>
///-------------------------------------------------------------------------------------------------
...
///-------------------------------------------------------------------------------------------------
/// <summary>	@brief ROTATE_LEFT rotates x left n bits. </summary>
///
/// <remarks>	Tony Wang, 15:43 19/3/21. </remarks>
///
/// <param name="x">	A void to process. </param>
/// <param name="n">	A void to process. </param>
///-------------------------------------------------------------------------------------------------
...
///-------------------------------------------------------------------------------------------------
/// <summary>	@brief	md5 initialization. Begins an md5 operation, writing a new context. </summary>
///
/// <remarks>	Tony Wang, 15:43 19/3/21. </remarks>
///
...
/// </summary>
///
/// <remarks>	Tony Wang, 15:44 19/3/21. </remarks>
///
...
///-------------------------------------------------------------------------------------------------
/// <summary>	md5 basic transformation. Transforms state based on block. </summary>
///
/// <remarks>	Tony Wang, 15:44 19/3/21. </remarks>
///
...
/// </summary>
///
/// <remarks>	Tony Wang, 15:46 19/3/21. </remarks>
///
